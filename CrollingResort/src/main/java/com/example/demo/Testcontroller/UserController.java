...
public class UserController {
	...
	public String showResortList() throws JsonProcessingException {
		// 국내 모든 스키장 리조트 보여주기.
	...
	public String getResort(@PathVariable(value = "id") int resortId) throws JsonProcessingException {
